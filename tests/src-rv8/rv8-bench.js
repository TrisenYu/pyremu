...
function benchmark_cmd(bench, cmd, args) {
    ...
    // The process.hrtime() method returns the 
    // current high-resolution real time in a [seconds, nanoseconds] tuple Array
    var obj = child_process.spawnSync(cmd, args) // 同步创建子进程
