...
class TestCompressedDifferential:
    ...
    # ===========================================================
    @pytest.mark.parametrize(
        "rd_creg,rs2_creg,v1,v2,op_bits",
        [
            (3, 5, 100, 30, 0b00),  # SUB
    ...
    # ===========================================================
    @pytest.mark.parametrize(
        "rd_creg,rs2_creg,v1,v2,op_bit5",
        [
            (3, 5, 100, 30, 0),  # SUBW
    ...
    # ===========================================================
    @pytest.mark.parametrize(
        "rd_creg,rs1_creg,init_rs1,uimm,mem_val",
        [
    ...
    # ===========================================================
    @pytest.mark.parametrize(
        "rs2_creg,rs1_creg,init_rs1,init_rs2,uimm",
        [
    ...
    def test_c_sd_vs_sd(self, rs2_creg, rs1_creg, init_rs1, init_rs2, uimm):
        ...
        c_instr = _c0(
            0b111,
            rs2_creg,
            ((rs1_creg << 7) | ((uimm >> 6) & 0x3) << 5 | ((uimm >> 3) & 0x7) << 10),
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (5, 0x100),
            (8, 0),
            (12, 0xFFFF_FFFF_FFFF_FFFE),  # PC & ~1 clears LSB
        ],
    )
    ...
    # ===========================================================
    @pytest.mark.parametrize(
        "rs1_creg,init_rs1,init_pc,offset",
        [
